  ...
  final List<Map<String, String>> symptoms = const [
    {
      "symptom": "Fever",
      "desc":
          "A high temperature (above 100°F) is the most common symptom of Covid.",
      "imgPath": "assets/symptoms/high_fever.png",
    },
    {
      "symptom": "Dry Cough",
      "desc": "Cough without mucus.",
    ...
    },
    {
      ...
      "desc": "Shortness of breath and a tight sensation in your chest",
      "imgPath": "assets/symptoms/sore_throat.png",
    },
  ];
            ...
            child: Material(
              ...
              child: AnimatedContainer(
                ...
                decoration: BoxDecoration(
                  color:
                      selectedIndex == index ? Colors.teal[50] : Colors.white,
                  borderRadius: BorderRadius.circular(15.0),
                ),
